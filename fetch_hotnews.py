# -*- coding: utf-8 -*-
"""
投研工作台（在线最新版·单仓滚动） · 今日热点推送 + 二级页《盘点今日热点》 + 历史日报（7天·逐日真实归档） 真实数据源（每日 08:30 自动运行）
...
REPO  = r"G:/Workbuddy/publish/touyan-workbench-app"
...
def main():
    ...
    # [v20] 二级页"盘点今日热点"模块表头时间戳已移除（按用户要求），不再替换；右上方 report-header-sub 由前端 JS 按 FETCH_TIME 动态渲染
    ...
    print("PUSHED -> qiao3412-cmd.github.io/touyan-workbench-app")
